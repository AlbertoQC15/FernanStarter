...
import java.util.Properties;
    public class Email {
        public static void enviarConGMail(String destinatario, String asunto, String cuerpo) {
            String remitente = "jesus.garcia.1207@fernando3martos.com";
            String clave = "yvmr djos lwyv jxwl";
        ...
        public static void main(String[] args) {
            String destinatario = "jesus.garcia.1207@fernando3martos.com"; // Destinatario del mensaje
            String asunto = "Correo de prueba enviado desde Java";
            String cuerpo = "<h1>Esta es una prueba de correo con html</h1>" +
                    "<p>hola <strong>Jesús</strong> que pasa</p>";
